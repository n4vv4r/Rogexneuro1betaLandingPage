...
## NAVI-3 en el unikernel

El chat de rxOS no emite castellano: emite `wsp_packet_t` (16 B) y aplica la máscara ES. Ver [NAVI-3 WSP](/docs/navi3) y la captura QEMU en ese doc.
