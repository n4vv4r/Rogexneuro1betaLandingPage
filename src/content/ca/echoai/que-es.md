...
**ECHO-1 va quedar tancat el 5 de setembre de 2026.** La suite canònica acaba
amb 488 proves correctes i un `expectedFailure` explícit: WALK-1 sense la resta
...
ECHO-2 portarà el mateix contracte a la supervivència autònoma i al
reconeixement d'objectes. ECHO-3 el connectarà amb sensors i un cos físic a
l'edge.
